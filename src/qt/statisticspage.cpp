...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "0 bitcent per block";
    }
    else if(pindexBest->nHeight < 4320)
    {
        subsidy = "125 bitcent per block";
    }
    else if(pindexBest->nHeight < 8640)
    {
        subsidy = "105 bitcent per block";
    }
    else if(pindexBest->nHeight < 12960)
    {
        subsidy = "80 bitcent per block";
    }
    else if(pindexBest->nHeight < 17280)
    {
        subsidy = "55 bitcent per block";
    }
    else if(pindexBest->nHeight < 20160)
    {
        subsidy = "35 bitcent per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " BCENT" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BCENT" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BCENT");
    }

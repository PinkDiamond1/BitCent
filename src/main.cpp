...
unsigned int nStakeMaxAge = 60 * 60 * 720 ;           //unlimited
unsigned int nModifierInterval = 10 * 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 35; //45 blocks for coins to mature gnome sayan
...
const string strMessageMagic = "bitcent Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight > 360 * DAILY_BLOCKCOUNT)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitcent", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "bitcent - now live";
        CTransaction txNew;
        txNew.nTime = 1418241522;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7d7635240903770bf0228c8c9a64356bbd04c980016a41ded84569e36faffa1a"));
        //block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xa4, 0xa9, 0xa2 };
